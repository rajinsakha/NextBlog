...
export default function Home() {
  return (
    <main className="flex flex-col px-8 sm:px-16 lg:px-32 py-8 gap-16">
      <div className="relative w-full">
        <div className="relative w-full max-sm:h-[50vh] lg:h-[75vh] ">
          <Image src="/hero-image.jpg" alt="Hero Image" sizes="100vw" fill style={{objectFit:'cover', borderRadius:'12px'}} />
        </div>

        <div className="w-fit max-[500px]: min-[500px]:w-2/3 lg:w-[43%] p-8 flex flex-col gap-6 bg-white dark:bg-titleColor rounded-xl absolute bottom-[-50px] left-[50px] border border-solid border-borderColor" style={{boxShadow:"0px 12px 24px -6px rgba(24, 26, 42, 0.12)"}}>
    ...
    <div className="mt-16">
      ...
      <Button variant="outline" className='border px-6 font-medium text-[#696A75]' style={{border:'1px solid rgba(105, 106, 117, 0.30)'}} asChild>
